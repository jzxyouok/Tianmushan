/**************************************************************************
 *
 *  Created by shushaoyong on 2016/12/14.
...
@implementation TMSWaveLoadView

+ (instancetype)loadingView
{
    return [[TMSWaveLoadView alloc] initWithFrame:CGRectMake(0, 0, 50, 50)];
}

+ (instancetype)loadingViewDuration
{
    return [[TMSWaveLoadView alloc] initWithFrame:CGRectMake(0, 0, 50, 50)];
}
